...
M.config = {
    ...
    cache_path = vim.fn.stdpath 'cache' .. '/vim_default_modern/cache',
}
...
function M.load()
    ...
    if f ~= nil then
        ...
        vim.notify(
            '[vim_default_modern.nvim] error trying to load cache file',
...
vim.opt.termguicolors=true]],
    ...
    local cache_dir = vim.fn.stdpath 'cache' .. '/vim_default_modern/'
    ...
    if not f then
        local path_debug_file = vim.fn.stdpath 'state'
            .. '/vim_default_modern-debug.lua'

        local msg = string.format(
            '[vim_default_modern.nvim] error, open %s for debugging',
            path_debug_file
        )
    ...
    if file then
        ...
        vim.notify(
            '[vim_default_modern.nvim] error trying to open cache file',
            vim.log.levels.ERROR
        )
    end
end
